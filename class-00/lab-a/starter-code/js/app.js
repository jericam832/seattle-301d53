...
function displayPics(){
  ...
  // The scope of rando is local to the while loop inside of the displayPics function. So, trying to log it outside of the function would give a reference error.
  console.log(viewed);
