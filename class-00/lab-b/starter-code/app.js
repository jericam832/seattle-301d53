...
const sum = (a, b, c, d) => { return a + b + c + d;};
...
// joe is global so it returns the joe object when joe.scope() is invoked
// 2. What is "this" when joe.scopeArrow() is invoked?
// It points to the window object and not the joe object
// 3. Explain why "this" is different when an arrow function is used.
// Since a joe is a global object, you cannot redeclare it with the scopeArrow function prototype
